...
typedef enum
{
    ...
    MUX_FUNC0 = 0x20,
    MUX_EVENTOUT = MUX_FUNC0, //PA1
    MUX_SPI_NSS = MUX_FUNC0, //PA4
    MUX_SPI_SCK = MUX_FUNC0, //PA5
    MUX_SPI_MISO = MUX_FUNC0, //PA6
    MUX_SPI_MOSI = MUX_FUNC0, //PA7
    MUX_TIM17_BKIN = MUX_FUNC0, //PA10
    MUX_SWDIO = MUX_FUNC0, //PA13
    MUX_SWCLK = MUX_FUNC0, //PA14
    MUX_TIM14_CH1 = MUX_FUNC0, //PB1
    
    MUX_FUNC1,
    MUX_UART_CTS = MUX_FUNC1, //PA0
    MUX_UART_RTS = MUX_FUNC1, //PA1
    MUX_UART_TX = MUX_FUNC1, //PA2, PA9, PA14
    MUX_UART_RX = MUX_FUNC1, //PA3, PA10
    MUX_UART_CK = MUX_FUNC1, //PA4
    MUX_TIM3_CH1 = MUX_FUNC1, //PA6
    MUX_TIM3_CH2 = MUX_FUNC1, //PA7
    MUX_IR_OUT =  MUX_FUNC1, //PA13
    MUX_TIM3_CH4 = MUX_FUNC1, //PB1
    
    MUX_FUNC2,
    MUX_TIM1_BKIN = MUX_FUNC2, //PA6
    MUX_TIM1_CH1N = MUX_FUNC2, //PA7
    MUX_TIM1_CH2 = MUX_FUNC2, //PA9
    MUX_TIM1_CH3 = MUX_FUNC2, //PA10
    MUX_TIM1_CH3N = MUX_FUNC2, //PB1
    
    MUX_FUNC3, //not supported on stm32f030f4
    
    MUX_FUNC4,
    MUX_TIM14_CH1_2 = MUX_FUNC4, //PA4, PA7
    MUX_I2C_SCL = MUX_FUNC4, //PA9
    MUX_I2C_SDA = MUX_FUNC4, //PA10
    
    MUX_FUNC5,
    MUX_TIM16_CH1 = MUX_FUNC5, //PA6
    MUX_TIM17_CH1 = MUX_FUNC5, //PA7
    
    MUX_FUNC6,
    MUX_EVENOUT_2 = MUX_FUNC6, //PA6, PA7
